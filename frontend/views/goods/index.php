...
$this->registerJsFile('@web/js/jqzoom-core.js',['depends'=>'yii\web\JqueryAsset']);
$js = <<<SCRIPT
        $(function(){
			$('.jqzoom').jqzoom({
	            zoomType: 'standard',
...
<div class="main w1210 mt10 bc">
    ...
    <div class="goods_content fl mt10 ml10">
        ...
        <div class="summary">
            ...
            <!-- 图片预览小部件,传入参数>商品id -->
            <?=\frontend\widgets\GoodsGalleryWidget::widget(['goods_id'=>$model->id])?>
            <!-- 图片预览区域 start -->
            ...
            <div class="goodsinfo fl ml10">
                <ul>
                    ...
                    <li><span>上架时间：</span><?=date('Y-m-d',$model->input_time);?></li>
